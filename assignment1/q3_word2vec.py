...
def negSamplingCostAndGradient(predicted, target, outputVectors, dataset, 
	...
	### YOUR CODE HERE
	# copied from https://github.com/dennybritz/cs224d-solutions/blob/master/assignment-1/assignment1/wordvec_sentiment.ipynb
...
def skipgram(currentWord, C, contextWords, tokens, inputVectors, outputVectors, 
	...
	v = inputVectors[current_word_index]

	for i in contextWords:
		target_word_index = tokens[i]
		cost_i, grad_in_i, grad_out_i = word2vecCostAndGradient(v, target_word_index, outputVectors, dataset)
		cost += cost_i
		gradIn[current_word_index] += grad_in_i
		gradOut += grad_out_i
	### END YOUR CODE
